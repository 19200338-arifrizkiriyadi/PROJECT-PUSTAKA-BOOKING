    ...
    {
        {
            ...
            $this->dompdf->render();
            $this->dompdf->stream("laporan_data_buku.pdf", array('Attachment' => 0)); // nama file pdf yang dihasilkan
        }
    }
    ...
    {
        {
            ...
            $this->load->view('anggota/laporan-pdf-anggota', $data);
            ...
            $this->dompdf->load_html($html);
            $this->dompdf->render();
            $this->dompdf->stream("laporan data anggota.pdf", array('Attachment' => 0)); // nama file pdf yang di hasilkan
        }
    }
    
    public function export_excel_anggota()
    {
        $data = array( 'title' => 'Laporan Anggota', 'anggota' => $this->ModelUser->getUserWhere()->result_array());
